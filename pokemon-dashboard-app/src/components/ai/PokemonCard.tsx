        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="space-y-1">
            {[
              ...
              <div key={s.label} className="flex items-center gap-1.5">
                <span className="text-[9px] font-bold w-6 text-right text-white/60">{s.label}</span>
                ...
                <span className="text-[9px] font-mono w-5 text-right text-white/80">{s.value}</span>
              </div>
            ))}
          </div>
          ...
          <div className="flex items-center justify-between mt-2 pt-1.5 border-t border-white/10">
            <span className="text-[10px] text-white/50">
              Total: <span className="font-bold text-white/80">{stats.total}</span>
            </span>
            {(height || weight) && (
